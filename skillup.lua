...
user_settings = {
    user_spells = {
        ...
        Geomancy = T{},
        Enhancing = T{'Barfira','Bartsonra','Baraera','Barthundra','Barblizzara','Barpoisonra','Protect','Shell'},
        Ninjutsu = T{},
        Singing = T{},
        Blue = T{},
        Summoning = T{'Carbuncle','Ramuh','Fenrir','Diabolos','Ifrit','Ice Spirit','Fire Spirit'}},
